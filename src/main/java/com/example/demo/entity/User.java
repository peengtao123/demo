 ...
 * 用户实体类
 * <p>
 * 对应数据库中的users表，存储系统用户的基本信息、认证信息和关联关系。
 * </p>
 * 
 * <h2>主要功能</h2>
 * <ul>
...
public class User {
     ...
     * 用户拥有的角色集合
     * <p>
     * 关联关系：多对多，通过user_role中间表关联
     * </p>
     * <p>
     * 加载策略：EAGER（立即加载），确保权限验证时可用
     * </p>
     */
     ...
     * 头像URL地址
     * <p>
     * 约束：可选，最多500个字符，支持HTTP/HTTPS链接或Base64
     * </p>
     */
    @Column(length = 500)
